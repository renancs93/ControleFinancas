...
public class ContaFragment extends Fragment {
    ...
    public static ContaFragment newInstance(String param1, String param2) {
        ...
        args.putString(ARG_DESCRICAO, param1);
        args.putString(ARG_SALDO, param2);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            txtDescricao = getArguments().getString(ARG_DESCRICAO);
            txtSaldo = getArguments().getFloat(ARG_SALDO);
        }
    }
